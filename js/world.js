...
const stationDescriptions = {
    pipeline: "The graphics pipeline is the sequence of steps used to create a 2D representation of a 3D scene. Major stages include vertex processing, primitive assembly, rasterization, and fragment processing.\n\nVertex processing transforms 3D vertices into 2D screen coordinates, applying model, view, and projection transformations. This stage also handles vertex attributes like colors and texture coordinates.\n\nPrimitive assembly connects vertices into geometric shapes like triangles, lines, or points. This stage determines how vertices are grouped and what type of primitive they form.\n\nRasterization converts geometric primitives into fragments (potential pixels) on the screen. It determines which pixels are covered by each primitive and interpolates vertex attributes across the surface.\n\nFragment processing calculates the final color of each fragment, applying textures, lighting, and other effects. This stage also handles depth testing, blending, and other per-pixel operations.",
